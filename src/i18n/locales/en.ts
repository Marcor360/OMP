...
export const en = {
  ...
  hospitality: {
    ...
    scheduleGeneratedMsg: '{{created}} meetings created and {{existing}} already existed.',
    ...
    scheduleDroppedTitle: 'List saved with dropped assignments',
    scheduleDroppedMsg: '{{count}} assignments were dropped:\n{{details}}',
    schedulePublishFailed: 'Could not publish',
    scheduleSaveFailed: 'Could not save',
    ...
    scheduleStatusPublished: 'Published',
    scheduleStatusDraft: 'Draft',
    schedulePublishManagerOnly: 'Only the department manager can publish the list.',
    scheduleArchive: 'Archive',
    scheduleArchiveConfirmTitle: 'Archive list',
    scheduleArchiveDraftConfirm: 'This draft will be archived and its active assignments will be cancelled.',
    scheduleArchivePublishedConfirm: 'The published list will be archived. Assignments already synced to meetings will NOT be reverted.',
    scheduleArchiveConfirmAction: 'Archive',
    scheduleArchivedTitle: 'List archived',
    scheduleArchivedMsg: 'The list was archived and {{count}} active assignments were cancelled.',
    scheduleArchiveFailed: 'Could not archive the list',
    scheduleMeetingsInRange: '{{count}} meeting in range',
    scheduleMeetingsInRange_plural: '{{count}} meetings in range',
    scheduleMidweek: 'Midweek',
    scheduleWeekend: 'Weekend',
    ...
    noAvailableSearchResults: 'No available people were found.',
    eligibilityBannerTitle: 'No eligible users',
    eligibilityBannerMessage: 'No brother has the elder or ministerial servant privilege recorded. Configure it under Users → Privileges.',
    eligibilityBannerAction: 'Go to Users',
